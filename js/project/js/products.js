...
function drawProductTable() {
    ...
    products.forEach((product) => {
        ...
        fila.innerHTML = `
            ...
            <td>$${product.price}</td>
            <td>
                <button class="btn bg-success text-white" id="edit-button${product.sku}"><i class="fa-regular fa-pen-to-square fa-sm"></i></button>
                <button class="btn bg-danger text-white"><i class="fa-regular fa-trash-can fa-sm"></i></button>
            </td>
        `;
        //Agrego la fila al cuerpo de la tabla
        productContainer.appendChild(fila);
        document.getElementById("edit-button"+product.sku).addEventListener('click', function () {
